    ...
    <div class="card-body text-center">
        ...
        <p>
            <small class="text-muted">
                <p>By. <a href="/authors/ {{ $post[0]->author->username }}" class="text-decoration-none">{{$post[0]-> author-> name}} </a> in <a href="/
        categories/ $post[0]->category->slug }}" class="text-decoration-none">{{ $post[0]
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <div class="position-absolute bg-dark px-3 py-2 "><a href=" /
        categories/ $post->category->slug }}" class="text-white text-decoration-none">{{ $post->category->name}}</a></div>
